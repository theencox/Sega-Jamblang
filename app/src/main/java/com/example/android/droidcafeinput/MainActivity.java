...
public class MainActivity extends AppCompatActivity {
     ...
     */
    public void showTopiOrder(View view) {
        mOrderMessage = getString(R.string.topi);
        harga = 5000;
     ...
     */
    public void showJerseyOrder(View view) {
        mOrderMessage = getString(R.string.jersey);
        harga = 10000;
        displayToast(mOrderMessage);
    }
     ...
     */
    public void showSepatuOrder(View view) {
        mOrderMessage = getString(R.string.sepatu);
        harga = 5000;
        displayToast(mOrderMessage);
    }
